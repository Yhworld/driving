...
function Cta() {
  return (
    ...
    <div className="md:w-3/4 flex flex-col items-center ">
      ...
      <Link to="/booking" class="mt-8 text-black bg-white hover:bg-black border hover:border-white hover:text-white focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-8 py-2.5 mr-2 mb-2  focus:outline-none ">Contact Us</Link>
      </div>
    </section>
  );
}
