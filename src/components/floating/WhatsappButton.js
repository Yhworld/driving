...
const WhatsAppButton = () => {
  const phoneNumber = "+447301626872"; // Replace with your WhatsApp phone number
  const message = "Hello! I have a question about your driving courses."; // Default message
